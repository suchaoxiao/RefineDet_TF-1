...
from net import bboxes as bb

from tensorflow.python.ops import control_flow_ops

from preprocess import tf_image
...
def distorted_bounding_box_crop(image,
    ...
    with tf.name_scope(scope, 'distorted_bounding_box_crop', [image, bboxes]):
        ...
        bboxes = bb.bboxes_resize(distort_bbox, bboxes)
        labels, bboxes = bb.bboxes_filter_overlap(labels, bboxes,
